  ...
  useEffect(() => {
    if (property) {
      form.reset({
        ...
        city: property.city,
        state: property.state != null ? property.state : undefined,
        zipCode: property.zipCode != null ? property.zipCode : undefined,
        ...
        airbnbProfileUrl: property.airbnbProfileUrl != null ? property.airbnbProfileUrl : undefined,
